...
public class CustomResponseEntityExceptionHandler {
    ...
    public final ResponseEntity handleUserDontExistException() {
    ...
    public final ResponseEntity handleNoMessageFoundException() {
        return new ResponseEntity(HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(ForbiddenActionOnBlog.class)
    public final ResponseEntity handleForbiddenActionOnBlog() {
